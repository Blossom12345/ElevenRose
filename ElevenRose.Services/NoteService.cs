...
namespace ElevenRose.Services
{
    public class NoteService
    {
        ...
        private NoteEntity GetNoteFromDatabase(ElevenRoseDbContext context, int noteId)
...

        {
            ...
            using (var ctx = new ElevenRoseDbContext())
